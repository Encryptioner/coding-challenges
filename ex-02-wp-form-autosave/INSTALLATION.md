...
2. Locate the `ex-02-wp-form-autosave` folder
...
1. **Download the Plugin**
   ...
   - You should have a file named `form-autosave.zip` or `ex-02-wp-form-autosave.zip`
...
1. **Download and Extract**
   ...
   # Extract
   unzip main.zip
   cd coding-challenges-main/ex-02-wp-form-autosave
   ```
...
4. **Upload Plugin Folder**
   - Upload the entire `ex-02-wp-form-autosave` folder
   - Ensure folder structure is:
     ```
     /wp-content/plugins/ex-02-wp-form-autosave/
     ├── form-autosave.php
     ├── assets/
     │   ├── js/
     │   └── css/
...
5. **Set Permissions** (if needed)
   ```bash
   chmod 755 ex-02-wp-form-autosave
   chmod 644 ex-02-wp-form-autosave/form-autosave.php
   ```
...
2. **Clone Repository**
   ...
   mv temp/ex-02-wp-form-autosave ./
   rm -rf temp
   ```

3. **Activate Plugin**
   ```bash
   wp plugin activate ex-02-wp-form-autosave
   ```
...
4. **Verify**
   ...
   You should see:
   ```
   ex-02-wp-form-autosave  1.0.0  active
   ```
...
```json
{
  ...
  "require": {
    "your-repo/ex-02-wp-form-autosave": "^1.0"
  }
}
```
...
**Solutions:**
1. Check folder structure - must be `/wp-content/plugins/ex-02-wp-form-autosave/`
...
# Remove plugin files
rm -rf wp-content/plugins/ex-02-wp-form-autosave
...
ln -s $(pwd) /path/to/wordpress/wp-content/plugins/ex-02-wp-form-autosave
