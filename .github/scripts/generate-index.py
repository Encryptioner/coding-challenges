...
def parse_readme():
    ...
    for line in lines:
        ...
        if match:
            num, name, folder, description, completed = match.groups()
            challenges.append({
                'number': int(num),
                'name': name,
                'folder': folder,
...
def generate_index_html(challenges):
...
<head>
    ...
    <title>Coding Challenges - 94 Implementations</title>
    <meta name="description" content="A comprehensive collection of 94 coding challenges from CodingChallenges.fyi - building practical tools and applications from scratch.">
...
<body>
    <header class="header">
        <div class="container">
            ...
            <p class="subtitle">Building 94 practical tools and applications from scratch</p>
            <div class="stats">
                <div class="stat">
    ...
    <main class="container">
        <section class="intro">
            <h2>About</h2>
            <p>
                This is a comprehensive collection of 94 coding challenges from
...
'''
        ...
        for challenge in section_challenges:
            ...
            github_url = f"https://github.com/Encryptioner/coding-challenges/tree/main/{challenge['folder']}"
...
'''
    ...
    <footer class="footer">
        <div class="container">
            <p>&copy; 2024 Coding Challenges. Educational implementations based on <a href="https://codingchallenges.fyi" target="_blank">CodingChallenges.fyi</a></p>
            <p>
                <a href="https://github.com/Encryptioner/coding-challenges" target="_blank">GitHub</a> •
                <a href="https://codingchallenges.fyi" target="_blank">Challenge Source</a>
            </p>
        </div>
    </footer>
...
def main():
    ...
    html = generate_index_html(challenges)
